...
<head>
    ...
    <link rel="stylesheet" href="/projects/travelApp/loginSystem/css/dashboardArticles.css">
    <!-- Ionicons icon pack -->
...
<?php
    ...
    include("../loginSystem/authSessionNoRedir.php");
    ...
    //SQL select-setning sendes til databasen sammen med verdiene fra tekstboksene	
        $sql= sprintf("SELECT idplanner,location,locationImage,stayTime,budget,timeZone,PlacesToEat,attractions,transport,otherNotes,googleMapsEmbed FROM planner");
...
<body>
    <main>
    <div id="navSidebar">
            <p id="logout"><a href="logout.php">Log ut</a></p>
            ...
            <?php if ($_SESSION['permissions'] == 'admin') { ?>
                <a class="" href="/projects/travelApp/loginSystem/dashboardUsers.php">
