...
<?php
    ...
    //SQL select-setning sendes til databasen sammen med verdiene fra tekstboksene	
        $sql= sprintf("SELECT articleId, articleTitle, articleIntro, articleText, articleImage FROM articles");
